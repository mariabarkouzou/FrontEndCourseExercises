...
Extend the [Book](https://athena.socialhackersacademy.org/topic/objects-and-object-constructors/#exercise) example from the previous lesson and turn it into a small Library app.
...
_Photo by Rafael Cosquiere from Pexels_